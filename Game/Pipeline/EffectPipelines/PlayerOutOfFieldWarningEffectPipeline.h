...
/// //////////////////////////////////////////////////////////
/// @brief  プレイヤーのフィールド外警告エフェクトパイプライン
/// //////////////////////////////////////////////////////////
class PlayerOutOfFieldWarningEffectPipeline {
...
public:
	...
	PlayerOutOfFieldWarningEffectPipeline() = default;
	~PlayerOutOfFieldWarningEffectPipeline() = default;

	/// @brief シングルトン化
	static PlayerOutOfFieldWarningEffectPipeline* GetInstance();
